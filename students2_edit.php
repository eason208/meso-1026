                ...
                <div class='card card-primary'>
                    ...
                    <div class='card-body' align=center>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "目前更改的是".$job."<br>";
                            echo "<form method=POST action=students2_update.php>";
                            echo "<input type=hidden value=$id name=id>";
                            echo "學號：<input type=text value='$sid' name=sid size=30>";
                            echo "<br>";
                            echo "姓名：<input type=text value='$name' name=name size=30>";
                            echo "<br>";
                            echo "密碼：<input type=text value='$pass' name=pass size=30>";
                            echo "<br>";
                            echo "班級"."<br>";
                            ...
                            echo "</form>";
                            echo "<a href='students2.php'>不修改，直接回去</a>";
                        } else {
                            echo "找不到你要編輯的紀錄<br>";
