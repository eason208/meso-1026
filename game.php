...
if ($user_type == NULL) {
  header("Location: login.php?redir=game.php");;
}
?>
    ...
    <div class='card-body' align=center>
      <div class='card card-primary'>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand" href="#">互動式遊戲(開發中)</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                <a class="nav-link" href="gmae.php">M幣轉一下<span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="poker.php">大小比一比</a>
              </li>
        ...
        <!-- 遊戲程式區 -->
        <form method="GET" action="./fuck.php">
          <div class="big">
            <div class="small" tag="0.01" c>M幣0.01</div>
            <div class="small" tag="0.01">M幣0.01</div>
            <div class="small" tag="0.1">M幣0.1</div>
            <div class="small" tag="0.01">M幣0.01</div>
            <div  name="cj" id="cj">抽獎</div>
            <div class="small" tag="0.1">M幣0.1</div>
            <div class="small" tag="0.01">M幣0.01</div>
        ...
        <script>
          ...
          function dianji() { //跳格子funtion
            ...
            function tingzhi() {
              // var fuck =document.write(fuck.innerHTML);;
              // alert(fuck);
              var fuck = document.getElementById("act").value;
              alert(fuck);
              // clearInterval(oTime); 
              // setTimeout("location.href='fuck.php';",0);  
            }   
