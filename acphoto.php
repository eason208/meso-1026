                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="acphoto.php">109學年度新生始業輔導<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="acphoto2.php">109學年度迎新活動</a>
                        </li>
                        <!-- <li class="nav-item">
  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="imags/activity/109-1-1.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>機械系工作人員合影</h5>
        </div>
      </div>
      <div class="carousel-item">
        <img src="imags/activity/109-1-2.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>會長宣布注意事項</h5>
