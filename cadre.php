        ...
        <div class='card-body' align=center>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="cadre.php">系學會幹部<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
            ...
            if ($result->num_rows > 0) { //檢查記錄的數量，看看是否有資料
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo"<br>";
                    echo"<div id='widget'>";
                    echo"<div class='btn-o bg' data-scribe='component:button' style='width: 100%;'><a href='https://www.instagram.com/$ig/' class='btn' id='b'><i class='fa fa-instagram ft14'></i><span class='label' id='l'>$ig</span></a></div>";
                    echo"</div>";
                    echo "</div></div><hr></div>";
                }
            } else {
